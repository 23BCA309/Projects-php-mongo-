...
<head>
  ...
  <!-- Fonts & Icons (same families you used) -->
...
<body>
  ...
  <div class="container" id="appContainer">
    <div class="brand-side">
      ...
      <p class="brand-text">Quick morning energizers, cozy stretch breaks, and calming breath—designed to make you smile.</p>
      ...
      <div class="forms-container">
        ...
        <div class="form login-container" id="loginContainer">
          ...
          <div class="input-group">
            ...
            <span class="password-toggle" onclick="togglePassword('login-password', this)"><i class="fas fa-eye"></i></span>
          </div>
        ...
        <div class="form register-container" id="registerContainer">
          ...
          <div class="input-group">
            ...
            <span class="password-toggle" onclick="togglePassword('register-password', this)"><i class="fas fa-eye"></i></span>
          </div>

          <div class="input-group">
            <i class="fas fa-lock"></i>
            <input type="password" id="confirm-password" placeholder="Confirm Password">
            <span class="password-toggle" onclick="togglePassword('confirm-password', this)"><i class="fas fa-eye"></i></span>
          </div>
          ...
          <button class="btn" onclick="submitRegister(event)">Create Account</button>
  ...
  <div class="modal-backdrop" id="forgotModal">
    <div class="modal" role="dialog" aria-modal="true" aria-labelledby="forgotTitle">
      ...
      <div style="display:flex;gap:10px">
        ...
        <button onclick="closeForgot()" style="flex:0 0 100px; border-radius:10px; border:none; background:#f2f4f2; color:#3d4b42; cursor:pointer">Cancel</button>
      </div>
    </div>
  </div>
